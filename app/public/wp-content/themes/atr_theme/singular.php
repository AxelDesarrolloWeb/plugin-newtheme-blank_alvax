            ...
            <div class="row row-block-post">
                <?php while (have_posts()): the_post(); ?>
                    ...
                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12 texto">
                        ...
                        //     'tipo-comida',
                        //     'Tipo Comida: ',
                        //     // Separar cada unos de los elementos
                        //     ', ',
                        //     // Lo que viene después de la lista
                        //     '.'
                        // );

                            $platos = get_the_term_list(
                                $post->ID,
                                'tipo-comida',
                                '<ul class="tipo-comida"><li>',
                                '</li><li>',
                                '</li></ul>' 
                            );
                            echo $platos;
                        ...
                        // Obtener los campos personalizados para este post
                        $custom_field = get_post_custom($post->ID);
                        //var_dump( $custom_field );
                        // Asegurarse de que la clave 'Helados' exista y sea un array
                        $helados = isset($custom_field['Helados']) ? $custom_field['Helados'] : array();
