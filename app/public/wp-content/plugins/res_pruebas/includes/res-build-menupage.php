...
class RES_Build_Menupage
{
    ...
    {
        $this->submenus = $this->add_submenu(
            $this->submenus,
            $parentSlug,
            $pageTitle,
            $menuTitle,
    ...
    public function run() {
        foreach($this->menus as $menus){
            ...
            add_menu_page($parentTitle ,$pageTitle, $menuTitle, $capability, $menuSlug, $functionName);
        };
    }
}
