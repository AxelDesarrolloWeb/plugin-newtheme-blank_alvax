...
* Plugin URI: https://cpt-plugin.com/
* Description: CPT-Plugin es un plugin creado por "Alvax" mientras cursaba desarrollo de plugins para wordpress.
* Version: 1.0.0
* Requires PHP: 7.0
* Author: Alvax
* Author URI: https://http://alvax-portfolio.wuaze.com/
...
function atr_post_type_recetas() {
    // Etiquetas para ewl post type
    $labels = array(
        'name' => _x('Recetas', 'Post Type General Name', 'cpt-plugin'),
        ...
        'updata_item' => __('Actualizar Receta', 'cpt-plugin'),
