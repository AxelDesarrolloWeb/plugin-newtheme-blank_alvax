 ...
 * @package    newtheme-blank
 * @subpackage newtheme-blank/includes
 * @autor Alvax <alvax019@gmail.com>
 * 
...
class NEW_Master
{
     ...
     * todos los ganghos (hooks) que alimentan el plugin
     * 
     * @since 1.0.0
     * @access protected
     ...
     * - NEW_Admin. Define todos los ganchos del área ded administración.
     * - NEW_Public. Define todos los ganchos del cliente/público.
     * 
     * @since 1.0.0
     * @access private
     */
    ...
    private function cargar_dependencias()
    {
        ...
        /**
         * La clase responsable de definir la funcionalidad de la internacionalización del plugin
         */
        ...
        /**
         * La clase responsable de crear los menús de nuestro panel de administración 
         * área de administración
         */
        ...
        /**
         * La clase responsable de definir todos lo métodos 
         * para los datos de los usuarios
         */
    ...
    private function definir_admin_hooks()
    {
        ...
        // Menus 
        $this->cargador->add_action('admin_menu', $this->new_admin, 'add_menu');
